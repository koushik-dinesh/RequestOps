...
INSERT INTO user_registrations (
  ...
  'VIO-0099', 'Priya Pending', 'priya.pending@violin.local', '+91-90000-00099', 'Employee', (SELECT id FROM departments WHERE code = 'OPS'), @demo_password, 'PENDING_APPROVAL'
)
...
WHERE r.request_number IN ('REQ-2026-000002', 'REQ-2026-000003')
