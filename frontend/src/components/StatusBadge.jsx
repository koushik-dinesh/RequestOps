...
const stylesByValue = {
  ...
  REQUIREMENTS_DEPARTMENT_REVIEW: { color: '#7C3AED', bg: '#F3E8FF', border: '#C4B5FD' },
  REQUIREMENTS_PM_REVIEW: { color: '#0369A1', bg: '#E0F2FE', border: '#7DD3FC' },
  REQUIREMENTS_APPROVED: { color: '#15803D', bg: '#DCFCE7', border: '#86EFAC' },
  DEVELOPER_ASSIGNED: { color: '#15803D', bg: '#DCFCE7', border: '#86EFAC' },
  SPRINT_PLANNING: { color: '#0F766E', bg: '#CCFBF1', border: '#5EEAD4' },
  SPRINT_CREATED: { color: '#7C3AED', bg: '#F3E8FF', border: '#C4B5FD' },
  SPRINT_ACTIVE: { color: '#0F766E', bg: '#CCFBF1', border: '#5EEAD4' },
  ...
  READY_FOR_COMPLETION: { color: '#0369A1', bg: '#E0F2FE', border: '#7DD3FC' },
