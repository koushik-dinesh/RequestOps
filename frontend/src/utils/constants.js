...
export const statusLabels = {
  ...
  UAT_PENDING: 'Requester Testing Pending',
  UAT_FAILED: 'Requester Testing Failed',
  UAT_APPROVED: 'Requester Approved',
  UAT_REJECTED: 'Requester Testing Returned',
  DEPLOYMENT_PENDING: 'Deployment Ready',
  DEPLOYED: 'Deployed',
